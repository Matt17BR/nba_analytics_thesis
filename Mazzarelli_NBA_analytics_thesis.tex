...
{\centering \subfloat[Shot precision relationship with game results\label{fig:fgpred-1}]{\includegraphics[width=0.49\linewidth]{latex/plots/plot_5} }\subfloat[3PT precision relationship with game results\label{fig:fgpred-2}]{\includegraphics[width=0.49\linewidth]{latex/plots/plot_6} }
